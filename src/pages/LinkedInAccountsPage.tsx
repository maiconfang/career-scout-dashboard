...
export default function LinkedInAccountsPage() {
  ...
  return (
    <PageContainer className="space-y-5" size="xl">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-slate-600">
              {t('linkedinAccounts.enterpriseDescription')}
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                <h3 className="text-xl font-extrabold text-agent-primary">LinkedIn Account</h3>
                <StatusBadge tone="slate">{t('linkedinAccounts.notConnected')}</StatusBadge>
              </div>
              <p className="mt-3 max-w-2xl text-sm text-slate-600">
                {t('linkedinAccounts.notConnectedDescription')}
              </p>
            </div>
            <button
              className="rounded-lg bg-brand-500 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-700"
      ...
      {connectedAccount && (
        <SectionCard>
          <div className="grid gap-5 xl:grid-cols-[1.1fr_1.9fr_auto] xl:items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <StatusBadge tone={statusTone(connectedAccount)}>{t(readableStatus(connectedAccount))}</StatusBadge>
                </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              <DetailItem fallback={t('linkedinAccounts.notAvailable')} label={t('linkedinAccounts.defaultAccount')} value={connectedAccount.default_account ? t('linkedinAccounts.yes') : t('linkedinAccounts.no')} />
              <DetailItem fallback={t('linkedinAccounts.notAvailable')} label={t('linkedinAccounts.lastConnection')} value={formatDate(connectedAccount.last_sync_at ?? connectedAccount.updated_at)} />
              <DetailItem fallback={t('linkedinAccounts.notAvailable')} label={t('linkedinAccounts.sessionState')} value={t(sessionState(connectedAccount))} />
              <DetailItem fallback={t('linkedinAccounts.notAvailable')} label={t('linkedinAccounts.connectedAccounts')} value={activeCount} />
            </div>
